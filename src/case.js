...
module.exports = async (conn, from, senderJid, cleanText, phoneNumber) => {
    try {
        ...
        if (user && user.registrationStep === 'AWAITING_NAME') { // senderJid used for lookup
        ...
        switch (command) {
            ...
            case 'start': {
                ...
                user = new User({ phoneId: senderJid, registrationStep: 'AWAITING_NAME' });
                await user.save();
                return await conn.sendMessage(from,
